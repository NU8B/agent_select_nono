...
class ChromaDB(VectorStore):
    ...
    def __init__(
        ...
        self.client = chromadb.Client(
            Settings(allow_reset=True, persist_directory=db_path, **configs)
        )
    ...
    def db_path(self, value: str) -> None:
        self.client = chromadb.Client(
            Settings(allow_reset=True, persist_directory=value, **self.configs)
        )
    ...
    def add_data(
        ...
        **optional_kwargs,
        ...
        try:
            params = {"documents": documents, "ids": ids, **optional_kwargs}
    ...
    def query_data(
        ...
        **optional_kwargs,
        ...
        try:
            ...
            params = {"n_results": n_results, **optional_kwargs}

            if query_text and query_embedding is None:
                if self.embedding_function:
                    query_embedding = self.embedding_function.create_embeddings(
                        query_text
                    )
